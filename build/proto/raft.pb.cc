...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_raft_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rf::InstallSnapShotRequest, lastincludeitem_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 48, -1, sizeof(::rf::InstallSnapShotResponse)},
};
...
const char descriptor_table_protodef_raft_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "deItem\030\004 \001(\005\022\016\n\006offset\030\005 \001(\005\022\014\n\004data\030\006 \003"
  "(\t\022\014\n\004done\030\007 \001(\010\"\'\n\027InstallSnapShotRespo"
  "nse\022\014\n\004term\030\001 \001(\0052\314\001\n\rRaftServerRpc\022D\n\rA"
  "ppendEntries\022\030.rf.AppendEntriesRequest\032\031"
  ".rf.AppendEntriesResponse\022)\n\004Vote\022\017.rf.R"
  "equestVote\032\020.rf.ResponseVote\022J\n\017InstallS"
  "napShot\022\032.rf.InstallSnapShotRequest\032\033.rf"
  ".InstallSnapShotResponseb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_raft_2eproto = {
  false, false, descriptor_table_protodef_raft_2eproto, "raft.proto", 832,
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          lastincludeitem_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 offset = 5;
...
::PROTOBUF_NAMESPACE_ID::uint8* InstallSnapShotRequest::_InternalSerialize(
  ...
  // int32 lastIncludeItem = 4;
  if (this->lastincludeitem() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_lastincludeitem(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:rf.InstallSnapShotRequest)
  ...
  if (this->lastincludeitem() != 0) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
        this->_internal_lastincludeitem());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:rf.InstallSnapShotRequest)
  ...
  if (from.lastincludeitem() != 0) {
    _internal_set_lastincludeitem(from._internal_lastincludeitem());
  }
  if (from.offset() != 0) {
